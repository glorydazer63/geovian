...
The peripherals is where the RaspberryPi comes into its own:
  ...
  - SIM Card socket - for loading up the operating system such as RaspianOS. In fact you can have multiple SD Cards and put different ARM based Linux distros on them, while keeping your data on a separate storage device, like a USB thumb drive or a USB Passport drive. 
