...
On AliExpress you can pick up a decent touchscreen like the [12.3" Model](https://www.uperfectmonitor.com/collections/touch-screen/products/uperfect-raspberry-pi-laptop-for-pi-3-4) for around 250 Australian (less discounts and coupons, but plus taxes). However, the issue is navigating through the minefield that is the online AliExpress experience. Good luck to you on that. I'm not having any luck, and trying to deal with these people in Hong Kong is a bit like trying to deal with ghosts. You just never see them.
